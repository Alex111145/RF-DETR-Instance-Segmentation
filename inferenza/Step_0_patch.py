...
def main():
    ...
    parser.add_argument("--input",   "-i", default=os.path.join(BASE_DIR, "ortomosaicoir.tif"),
                        help="Path ortomosaico IR input")
    parser.add_argument("--output",  "-o", default=os.path.join(OUTPUT_DIR, "training_patches_ir"),
